...
#
# Example:
#   bash examples/coding_agent_rl/infer/run_infer_cc_offload_traj.sh
#   CONCURRENCY=4 bash examples/coding_agent_rl/infer/run_infer_cc_offload_traj.sh --eval
#   OUT_DIR=/tmp/new_run bash examples/coding_agent_rl/infer/run_infer_cc_offload_traj.sh
