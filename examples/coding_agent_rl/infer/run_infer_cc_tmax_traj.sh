...
#
# Example:
#   bash examples/coding_agent_rl/infer/run_infer_cc_tmax_traj.sh
#   CONCURRENCY=1 TIME_BUDGET=600 bash examples/coding_agent_rl/infer/run_infer_cc_tmax_traj.sh
#   bash examples/coding_agent_rl/infer/run_infer_cc_tmax_traj.sh --no-thinking
...
JSONL="${PROMPT_DATA:-${EXAMPLE_DIR}/data/tmax_train_full.jsonl}"
