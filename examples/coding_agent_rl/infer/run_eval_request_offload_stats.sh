...
#
# Then:
#   bash examples/coding_agent_rl/infer/run_eval_request_offload_stats.sh
...
MODEL="${SERVED_MODEL_NAME:-${MODEL:-PyroDash-4B-SFT-07313}}"
# im_end / eos / <|/llm_offload|>
STOP_TOKEN_IDS="${STOP_TOKEN_IDS:-248046,248044,248078}"
