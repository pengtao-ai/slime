...
#
# Example:
#   bash examples/coding_agent_rl/scripts/launch_sglang_pyrodash4b.sh
#   CUDA_VISIBLE_DEVICES=1 PORT=30001 bash examples/coding_agent_rl/scripts/launch_sglang_pyrodash4b.sh
#   SGLANG_HOST=127.0.0.1 PORT=30000 bash examples/coding_agent_rl/scripts/launch_sglang_pyrodash4b.sh
#
# Smoke check:
...
STUB_ROOT="${EXAMPLE_DIR}/sglang_infer_stubs"
