...
#
# Example:
#   bash examples/coding_agent_rl/scripts/run_regrade_patches.sh --dry-run
#   CONCURRENCY=4 bash examples/coding_agent_rl/scripts/run_regrade_patches.sh
...
#   bash examples/coding_agent_rl/scripts/run_regrade_patches.sh --only-regraded
#   bash examples/coding_agent_rl/scripts/run_regrade_patches.sh --indices 851,852 --force
#   LIMIT=20 bash examples/coding_agent_rl/scripts/run_regrade_patches.sh
...
JSONL="${PROMPT_DATA:-${EXAMPLE_DIR}/data/swe_train_scaleswe.jsonl}"
